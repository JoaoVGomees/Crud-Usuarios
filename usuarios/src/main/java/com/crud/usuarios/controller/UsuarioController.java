...
import com.crud.usuarios.model.dto.ToDTO.UsuarioConverter;
...
public class UsuarioController {
    ...
    public ResponseEntity<UsuarioDTO> insert(@RequestBody @Valid Usuario usuario) {
        ...
        return ResponseEntity.created(ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}")
                             ...
                             .body(UsuarioConverter.toDTO(savedUsuario));
    }
    
    @PutMapping("/{id}") 
    public ResponseEntity<UsuarioDTO> update(@PathVariable int id, @RequestBody @Valid Usuario usuario) {
